    ...
    <div class="container my-5">
      <div class="section-wrapper">
        <div class="text-center mb-5">
          ...
          La mica dieléctrica, ya sea de flogopita o muscovita, encuentra diversas aplicaciones en la industria aeronáutica debido a sus propiedades eléctricas, térmicas y mecánicas protegiendo del calor generado a componentes clave durante la operación como son sensores, actuadores y pantallas además de prevenir interferencias electromagnéticas.
          </p>
        </div>

        <div class="row align-items-center">
          <div class="col-lg-6 mb-4 mb-lg-0">
            <img src="../img/aeronautica.jpg" alt="Industria Automotriz" class="feature-large">
          </div>
          <div class="col-lg-6">
            <div class="text-block">
              <p><strong>Algunas aplicaciones más comunes son:</strong></p>
              <ul class="mt-3">
                <li>Aislamiento en Sistemas Eléctricos de Aeronaves.</li>
                <li>Aislamiento Térmico en Equipos Electrónicos</li>
                <li>Cubiertas Transparentes en Instrumentación</li>
                <li>Aislamiento en Sistemas de Propulsión</li>
                <li>Aisladores en Sistemas de Comunicación.</li>
                <li>Aislamiento en Sistemas de Navegación y Control de Vuelo</li>
                <li>Aislamiento en Equipos de Entretenimiento a Bordo</li>
