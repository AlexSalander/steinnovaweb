      ...
      <div class="section-wrapper">
        <div class="text-center mb-5">
          ...
          <p class="mt-3 mx-auto" style="max-width: 800px;">
            La mica dieléctrica, ya sea de flogopita o muscovita, encuentra diversas aplicaciones en la industria
            aeronáutica debido a sus propiedades eléctricas, térmicas y mecánicas protegiendo del calor generado a
            componentes clave durante la operación como son sensores, actuadores y pantallas además de prevenir
